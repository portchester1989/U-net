...
class myUnet(object):
    ...
    def train(self,mode='pretrain',img_paths = None,bounding_box_path = None,save_path=None,imgs_train_pre=None,imgs_mask_train_pre=None,pretrained_weights=None):
        ...
        model = self.get_body(pretrained½I_weights)
        ...
        print('Fitting model...')
        model.fit(x=imgs_train, y=imgs_mask_train, validation_split=0.2, batch_size=1, epochs=2, verbose=1, shuffle=True, callbacks=[model_checkpoint,early_call_back,tensor_board])
