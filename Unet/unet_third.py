...
from keras.layers import concatenate, Conv2D, MaxPooling2D, UpSampling2D, Dropout, Flatten, Dense, Softmax
...
class myUnet(object):
    ...
    def get_body(self):
        ...
        #conv9 = Flatten(conv9)
        #conv10 = Dense(num_anchors * 6)(conv9)
        ...
        #print('model compile')
        return model
    def train(self,mode='pretrain',img_paths = None,bounding_box_path = None,save_path=None,imgs_train_pre=None,imgs_mask_train_pre=None):
        print("loading data")
        if mode == 'pretrain':
        ...
        print('Fitting model...')
        model.fit(x=imgs_train, y=imgs_mask_train, validation_split=0.2, batch_size=1, epochs=1, verbose=1, shuffle=True, callbacks=[model_checkpoint])
