...
class myUnet(object):
    ...
    def get_body(self,pretrained_weights=None):
        ...
        conv1 = Conv2D(16, 3, padding='same', kernel_initializer='he_normal',kernel_regularizer = regularizers.l2(.01),name='conv1_1')(inputs)
        ...
        print(pool1.shape)
        print('\n')
        conv2 = Conv2D(32, 3, padding='same', kernel_initializer='he_normal',kernel_regularizer = regularizers.l2(.01),name='conv2_1')(pool1)
        ...
        print(pool2.shape)
        print('\n')
        conv3 = Conv2D(64, 3, padding='same', kernel_initializer='he_normal',kernel_regularizer = regularizers.l2(.01),name='conv3_1')(pool2)
        ...
        print(pool3.shape)
        print('\n')
        conv4 = Conv2D(128, 3, padding='same', kernel_initializer='he_normal',kernel_regularizer = regularizers.l2(.01),name='conv4_1')(pool3)
        #conv4 = BatchNormalization()(conv4)
        #conv4 = Activation(activation='relu')(conv4)
        #print(conv4.shape)
        conv4 = Conv2D(128, 3, padding='same', kernel_initializer='he_normal',kernel_regularizer = regularizers.l2(.01),name='conv4_2')(conv4)
        conv4 = BatchNormalization()(conv4)
        conv4 = Activation(activation='relu')(conv4)
        print(conv4.shape)
        ...
        conv5 = Conv2D(256, 3, padding='same', kernel_initializer='he_normal',kernel_regularizer=regularizers.l2(.01),name='conv5_1')(pool4)
        ...
        print('\n')
        up6 = Conv2D(128, 2, padding='same', kernel_initializer='he_normal',kernel_regularizer=regularizers.l2(.01),name='up6')(UpSampling2D(size=(2, 2))(drop5))
        ...
        print('merge: ')
        print(merge6.shape)
        conv6 = Conv2D(128, 3, padding='same', kernel_initializer='he_normal',kernel_regularizer=regularizers.l2(.01),name='conv6_1')(merge6)
        ...
        conv6 = BatchNormalization()(conv6)
        conv6 = Activation(activation='relu')(conv6)
        up7 = Conv2D(64, 2, padding='same', kernel_initializer='he_normal',kernel_regularizer=regularizers.l2(.01),name='up7')( UpSampling2D(size=(2, 2))(conv6))
        up7 = BatchNormalization()(up7)
        up7 = Activation(activation='relu')(up7)
        merge7 = concatenate([conv3, up7], axis=3)
        conv7 = Conv2D(64, 3, padding='same', kernel_initializer='he_normal',kernel_regularizer=regularizers.l2(.01),name='conv7_1')(merge7)
        ...
        #conv7 = BatchNormalization()(conv7)
        #conv7 = Activation(activation='relu')(conv7)
        up8 = Conv2D(32, 2, padding='same', kernel_initializer='he_normal',kernel_regularizer=regularizers.l2(.01),name='up8')( UpSampling2D(size=(2, 2))(conv7))
        up8 = BatchNormalization()(up8)
        up8 = Activation(activation='relu')(up8)
        merge8 = concatenate([conv2, up8], axis=3) 
        conv8 = Conv2D(32, 3, padding='same', kernel_initializer='he_normal',kernel_regularizer=regularizers.l2(.01),name='conv8_1')(merge8)
        ...
        #conv8 = BatchNormalization()(conv8)
        #conv8 = Activation(activation='relu')(conv8)
        up9 = Conv2D(16, 2, padding='same', kernel_initializer='he_normal',kernel_regularizer=regularizers.l2(.01),name='up9')( UpSampling2D(size=(2, 2))(conv8))
        up9 = BatchNormalization()(up9)
        up9 = Activation(activation='relu')(up9)
        merge9 = concatenate([conv1, up9], axis=3)
        conv9 = Conv2D(16, 3, padding='same', kernel_initializer='he_normal',kernel_regularizer=regularizers.l2(.01),name='conv9_1')(merge9)
        ...
        #conv9 = BatchNormalization()(conv9)
        #conv9 = Activation(activation='relu')(conv9)
        conv9 = Conv2D(2, 3, padding='same', kernel_initializer='he_normal',kernel_regularizer=regularizers.l2(.01),name='conv9_3')(conv9)
        conv9 = BatchNormalization()(conv9)
        conv9 = Activation(activation='relu')(conv9)
    ...
    def train(self,mode='pretrain',img_paths = None,bounding_box_path = None,save_path=None,imgs_train_pre=None,imgs_mask_train_pre=None,pretrained_weights=None):
        ...
        print('Fitting model...')
        model.fit(x=imgs_train, y=imgs_mask_train, validation_split=0.2, batch_size=64, epochs=20, verbose=1, shuffle=True, callbacks=[model_checkpoint,tensor_board])
